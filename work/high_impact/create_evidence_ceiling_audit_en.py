...
def main():
 ...
 d.add_heading('Resolved submission metadata',1)
 for x in ['Author order, affiliations, equal-contribution statement, corresponding-author contact and ORCID supplied.','Funding, CRediT contributions, competing-interest statement and public-data ethics statement supplied.','Archived release DOI 10.5281/zenodo.22726636 retained in the manuscript and submission metadata.','Retain the disclosure that the revision-stage search was not prospectively registered.','Do not convert the heterogeneous disease cohorts into a clinical-prediction claim.']:d.add_paragraph(x,style='List Bullet')
 ...
 table(d,['Requirement','Status'],[['Article title up to 15 words','Pass: 14 words'],['Abstract below 150 words','Pass: 137 words'],['Statistics and reproducibility section','Pass'],['Data and Code availability','Present; archived release DOI supplied'],['PRISMA checklist','Complete; non-registration disclosed'],['Figures in text plus high-resolution files','Pass: PNG/PDF/TIFF'],['AI-use disclosure in Methods','Present; authors accept responsibility']])
