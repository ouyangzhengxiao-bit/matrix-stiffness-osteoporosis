...
def main():
 ...
 for x in ['Complete names, affiliations, corresponding-author email and ORCID.','Verify funding, CRediT contributions, conflicts of interest and the institutional determination for secondary public-data analysis.','Deposit code and derived data in a durable public repository and replace the URL/DOI placeholder.','Retain the disclosure that the revision-stage search was not prospectively registered.','Do not convert the heterogeneous disease cohorts into a clinical-prediction claim.']:d.add_paragraph(x,style='List Bullet')
 ...
 table(d,['Requirement','Status'],[['Article title up to 15 words','Pass: 11 words'],['Abstract below 150 words','Pass: 137 words'],['Statistics and reproducibility section','Pass'],['Data and Code availability','Present; repository DOI awaits author'],['PRISMA checklist','Complete; non-registration disclosed'],['Figures in text plus high-resolution files','Pass: PNG/PDF/TIFF'],['AI-use disclosure in Methods','Present; author verification required']])
